...
### Added
- The `get_acquisition`, `get_acquisitions`, `get_product`, and `product_exists` functions now accept a `cmr_host` keyword argument; defaults to `'cmr.earthdata.nasa.gov'`.
